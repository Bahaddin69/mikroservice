...
const CLIENT_ID = process.env.CLIENT_ID || "catalog-service"; // Kafka client ID
const GROUP_ID = process.env.GROUP_ID || "catalog-service-group"; // Consumer group ID
const BROKERS = [process.env.BROKER_1 || "localhost:9092"]; // Kafka broker adresleri
...
let producer: Producer; // Mesaj göndermek için Kafka producer
let consumer: Consumer; // Mesaj tüketmek için Kafka consumer

// Topic yoksa Kafka'da oluşturur
